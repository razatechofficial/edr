...
echo "  Backup: sudo bash ${ROOT}/scripts/deploy/backup_controlplane.sh"
echo "  Restore: sudo EDR_RESTORE_CONFIRM=1 bash ${ROOT}/scripts/deploy/restore_controlplane.sh <backup.tar.gz>"
