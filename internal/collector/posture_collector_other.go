...
// PostureCollector performs cheap read-only posture probes (G-POSTURE) on tier-minimal GOOS.
...
// NewPostureCollector returns a posture collector when posture_enabled is set.
